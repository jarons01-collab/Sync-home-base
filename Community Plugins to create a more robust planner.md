...
---
- [-] [Relay](obsidian://show-plugin?id=system3-relay) (enables real-time collaboration)
- [x] [Calendar Bases](obsidian://show-plugin?id=calendar-bases) (adds calendar view)
- [x] [Maps](obsidian://show-plugin?id=maps) (adds map view)
