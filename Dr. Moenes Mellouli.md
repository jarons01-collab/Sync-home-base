...
email:
  - mmellouli@ccis.edu
image-id: "[[moenes-mellouli-thmb.jpg]]"
---
### Bio
...
### Has taught[^1]
- Calculus I (`MATH 201`)
- Mathematical Statistics and Probability (`MATH 338`)
- Statistics I (`MATH 250`)
- Financial Mathematics (`MATH 280`)
### Will be teaching
- [[General Linear Models]] I & II (`STAT 421` and `422`)

[^1]: All of the courses within this heading are required (in one way or another) to complete the [Actuarial Mathematics minor](http://catalog.ccis.edu/preview_program.php?catoid=42&poid=4001&_gl=1*rjhuy9*_gcl_au*MTg0MzQ1MDA5MC4xNzc3NTc2OTUz*FPAU*MTg0MzQ1MDA5MC4xNzc3NTc2OTUz).
